...
@WebFilter(
		...
		initParams = {  			
				...
				@WebInitParam(name = "mustLogin2", value = "/_14_shopAP/*"),				
				@WebInitParam(name = "mustLogin3", value = "/_04_Orderlist/*"),				
				@WebInitParam(name = "mustLogin4", value = "/_04_ShopCart/*"),				
				@WebInitParam(name = "mustLogin5", value = "/_03_CultureAndCreativeShops_CMS/*")				
		})
